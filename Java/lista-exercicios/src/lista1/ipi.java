...
public class ipi {
	...
	public static void main(String[] args) {
		...
		System.out.println("Peça 1, código: " + codigoPeca1 + ", quantidade de peças: " + quantidade1);
		System.out.println("Peça 2, código: " + codigoPeca2 + ", quantidade de peças: " + quantidade2);
